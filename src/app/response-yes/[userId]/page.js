...
export default async function ResponseYesPage({ params }) {
  const response = await fetch(`https://first-react-app-39662-default-rtdb.firebaseio.com/responseYes.json?orderBy="userId"&equalTo="${params.userId}"`, { cache: 'no-store' });
